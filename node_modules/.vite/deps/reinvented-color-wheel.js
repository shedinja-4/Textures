...
//#endregion
//#region node_modules/pure-color/convert/hsl2hsv.js
var require_hsl2hsv = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/pure-color/convert/hsv2hsl.js
var require_hsv2hsl = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/reinvented-color-wheel/es/rgb2hsv.js
var import_hsl2hsv = /* @__PURE__ */ __toESM(require_hsl2hsv());
var import_hsv2hsl = /* @__PURE__ */ __toESM(require_hsv2hsl());
...
//#endregion
//#region node_modules/reinvented-color-wheel/es/hsv2rgb.js
...
//#endregion
//#region node_modules/pure-color/util/clamp.js
...
//#endregion
//#region node_modules/pure-color/convert/rgb2hex.js
var require_rgb2hex = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var clamp = require_clamp();
	function componentToHex(c) {
		var hex = Math.round(clamp(c, 0, 255)).toString(16);
...
//#endregion
//#region node_modules/pure-color/parse/hex.js
var require_hex = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	function expand(hex) {
		var result = "#";
	...
	function hex(hex) {
		if (hex.length === 4 || hex.length === 5) hex = expand(hex);
		var rgb = [
...
//#endregion
//#region node_modules/reinvented-color-wheel/es/normalize.js
var import_rgb2hex = /* @__PURE__ */ __toESM(require_rgb2hex());
var import_hex = /* @__PURE__ */ __toESM(require_hex());
...
//#endregion
//#region node_modules/reinvented-color-wheel/es/window.js
var window = typeof globalThis !== "undefined" ? globalThis : self;
//#endregion
//#region node_modules/reinvented-color-wheel/es/on-drag.js
var onDrag = "PointerEvent" in window ? function(element, onDragStart, onDragMove) {
	element.addEventListener("pointerdown", function(event) {
		if (event.button === 0 && onDragStart(event) !== false) this.setPointerCapture(event.pointerId);
	});
	element.addEventListener("pointermove", function(event) {
		if (this.hasPointerCapture(event.pointerId)) onDragMove(event);
	});
...
//#endregion
//#region node_modules/reinvented-color-wheel/es/reinvented-color-wheel.js
var defaultOptions = {
	hsv: [
		0,
		100,
...
var inverseTransform = function(element) {
	...
	while (element = element.parentElement) ancestors.push(element);
...
var ReinventedColorWheel = function() {
	function ReinventedColorWheel(options) {
		...
		this._hsv = normalizeHsvOrDefault(options.hsv ? options.hsv : options.hsl ? ReinventedColorWheel.hsl2hsv(options.hsl) : options.rgb ? ReinventedColorWheel.rgb2hsv(options.rgb) : options.hex ? ReinventedColorWheel.rgb2hsv(ReinventedColorWheel.hex2rgb(options.hex)) : void 0, defaultOptions.hsv);
		...
		var onDragStartHue = function(event) {
			...
			if (x * x + y * y < wheelInnerRadius * wheelInnerRadius) return false;
			onDragMoveHue(event);
		};
	...
	ReinventedColorWheel.hsv2hsl = import_hsv2hsl.default;
	ReinventedColorWheel.hsl2hsv = import_hsl2hsv.default;
	ReinventedColorWheel.hsv2rgb = hsv2rgb;
	ReinventedColorWheel.rgb2hsv = rgb2hsv;
	ReinventedColorWheel.rgb2hex = import_rgb2hex.default;
	ReinventedColorWheel.hex2rgb = import_hex.default;
...
//# sourceMappingURL=reinvented-color-wheel.js.map